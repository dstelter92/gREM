...
#
# Usage:
# python get-hist-enthalpies 2 5
#
##################
### PARAMETERS ###
##################
...
# Col index
col = 4 # total potential energy
#col = 3 # effective temperature
##################
...
for i in range(NumReplica):
    ...
    for j in range(stop-start):
        ...
        Hist = genfromtxt(hname, skip_header=header, skip_footer=footer, usecols = (0,col))
