...
#
# Expects a list enthalpies for each replica in separate files.
...
#
# Files named as:
# "./ent_%d_upto%d.dat" % (lambdas[l], data_num)
# Where lambdas identifies the replica and data_num
# is an arbitrary identifier for how many restarts have been done.
#
...
lambdas = array(map(int, idata[7].split())) # List of lambdas
